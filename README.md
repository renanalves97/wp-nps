...
In the WordPress admin, go to Plugins and activate NPS Feedback System.
A new Avaliações NPS menu will appear in the admin sidebar.
Usage
...
Author
Renan Alves https://renanalves.com.br/
